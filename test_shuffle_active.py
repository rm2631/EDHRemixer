...
def test_shuffle_manager_filters_inactive():
    ...
    assert (
        mock_connector.get_deck_content.call_count == 2
...
def test_shuffle_manager_all_active():
    ...
    collections = [
        Collection(
            name="Source1",
            url="https://www.moxfield.com/decks/s1",
            is_source=True,
            active=True,
        ),
        Collection(
            name="Source2",
            url="https://www.moxfield.com/decks/s2",
            is_source=True,
            active=True,
        ),
        Collection(
            name="Target1",
            url="https://www.moxfield.com/decks/t1",
            is_source=False,
            active=True,
        ),
    ]
    ...
    assert (
        mock_connector.get_deck_content.call_count == 3
...
def test_shuffle_manager_all_inactive():
    ...
    assert (
        mock_connector.get_deck_content.call_count == 0
