...
def test_priority_sorting():
    ...
    collections = [
        Collection(name="Low", url="https://www.moxfield.com/decks/a", is_source=True, priority=1),
        Collection(name="High", url="https://www.moxfield.com/decks/b", is_source=True, priority=5),
        Collection(name="Medium", url="https://www.moxfield.com/decks/c", is_source=True, priority=3),
    ]
